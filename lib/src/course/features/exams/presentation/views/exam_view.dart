...
class _ExamViewState extends State<ExamView> {
  ...
  Future<void> submitExam() async {
    if (!examController.isTimeUp) {
      ...
      final isMinutesLeft = examController.remainingTimeInSecons > 60;
      final isHoursLeft = examController.remainingTimeInSecons > 3600;
      ...
      final endExam = await showDialog<bool>(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text(
              'You have ${examController.remainingTime}'
