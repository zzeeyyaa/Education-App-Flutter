...
void main() {
  ...
  final tNotificationModel = NotificationModel.empty();
  ...
  group('fromMap', () {
    test('should return a [NotificationModel] with the right data', () {
      ...
      expect(result, equals(tNotificationModel));
    });
  });

  group('toMap', () {
    test('should return a [DataMap] with the right data', () {
      final result = tNotificationModel.toMap()..remove('sentAt');
  ...
  group('copyWith', () {
    test('should return a [NotificationModel] with the rigth data', () {
      final result = tNotificationModel.copyWith(
