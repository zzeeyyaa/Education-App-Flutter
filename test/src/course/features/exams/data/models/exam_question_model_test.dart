...
void main() {
  ...
  group('ExamQuestionModel', () {
    test('should be a subclass of [ExamQuestion] entity', () {
  ...
  group('fromMap', () {
    test('should return a valid [ExamQuestionModel] when the Json is not Null',
        () async {
  ...
  group('fromUploadMap', () {
    test('should reutn a valid [ExamQuestionModel] when the Json is not null',
        () async {
  ...
  group('copyWith', () {
    test('should return a new []ExamQuestionModel] with the same value',
        () async {
      final result = tExamQuestionModel.copyWith(id: 'New Id');
