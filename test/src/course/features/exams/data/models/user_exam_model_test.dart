...
void main() {
  ...
  group('UserExamModel', () {
    test('should be a subclass of [UserExams] entities', () async {
  ...
  group('copyWith', () {
    test('should return new [UserExamModel] with the same value', () async {
      final result = tUserExamModel.copyWith(examId: 'new exam id');
      expect(result.examId, 'new exam id');
    });
  });
}
